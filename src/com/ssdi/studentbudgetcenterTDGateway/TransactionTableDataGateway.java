		...
		PreparedStatement preparedstatement=null,preparedstatement1=null;
		  try {
				...
				preparedstatement.execute();
					...
					preparedstatement1=conn.prepareStatement("select BudgetCategory,transactionDate,transactionAmount,description from Transaction where username='"+username+"';");
		...
		ArrayList<CompareObject> colist=new ArrayList<CompareObject>();
		  try {
				...
				preparedstatement.execute();
					...
					ResultSet rs=preparedstatement1.executeQuery();
					preparedstatement2=conn.prepareStatement("select count(distinct(username)) from Transaction where username<>'"+username+"';");
